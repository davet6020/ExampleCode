        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ ($errors->has('bom_line_default')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('bom_line_default', old('bom_line_default'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-6 {{ ($errors->has('bom_line_charge_per')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('bom_line_charge_per', old('bom_line_charge_per'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ ($errors->has('smt_default')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('smt_default', old('smt_default'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-6 {{ ($errors->has('smt_charge_per')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('smt_charge_per', old('smt_charge_per'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ ($errors->has('tht_default')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('tht_default', old('tht_default'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-6 {{ ($errors->has('tht_charge_per')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('tht_charge_per', old('tht_charge_per'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ ($errors->has('bga_default')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('bga_default', old('bga_default'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-6 {{ ($errors->has('bga_charge_per')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('bga_charge_per', old('bga_charge_per'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ ($errors->has('sides_default')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('sides_default', old('sides_default'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-6 {{ ($errors->has('sides_charge_per')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('sides_charge_per', old('sides_charge_per'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ ($errors->has('flat_fee_default')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('flat_fee_default', old('flat_fee_default'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-6 {{ ($errors->has('flat_fee_charge_per')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('flat_fee_charge_per', old('flat_fee_charge_per'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-4 {{ ($errors->has('function_x')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('function_x', old('function_x'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-4 {{ ($errors->has('function_b')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('function_b', old('function_b'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-4 {{ ($errors->has('quantity_default')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('quantity_default', old('quantity_default'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-4 {{ ($errors->has('assembled_turn_day_1')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('assembled_turn_day_1', old('assembled_turn_day_1'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-4 {{ ($errors->has('assembled_turn_day_2')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('assembled_turn_day_2', old('assembled_turn_day_2'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-4 {{ ($errors->has('assembled_turn_day_3')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('assembled_turn_day_3', old('assembled_turn_day_3'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-4 {{ ($errors->has('assembled_turn_day_4')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('assembled_turn_day_4', old('assembled_turn_day_4'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-4 {{ ($errors->has('assembled_turn_day_5')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('assembled_turn_day_5', old('assembled_turn_day_5'), ['class' => 'form-control']) !!}
        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ ($errors->has('2_layer_base_price')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('2_layer_base_price', old('2_layer_base_price'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-6 {{ ($errors->has('2_layer_sq_inch_price')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('2_layer_sq_inch_price', old('2_layer_sq_inch_price'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ ($errors->has('4_layer_base_price')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('4_layer_base_price', old('4_layer_base_price'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-6 {{ ($errors->has('4_layer_sq_inch_price')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('4_layer_sq_inch_price', old('4_layer_sq_inch_price'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ ($errors->has('6_layer_base_price')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('6_layer_base_price', old('6_layer_base_price'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-6 {{ ($errors->has('6_layer_sq_inch_price')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('6_layer_sq_inch_price', old('6_layer_sq_inch_price'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ ($errors->has('8_layer_base_price')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('8_layer_base_price', old('8_layer_base_price'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-6 {{ ($errors->has('8_layer_sq_inch_price')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('8_layer_sq_inch_price', old('8_layer_sq_inch_price'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-4 {{ ($errors->has('unassembled_turn_day_1')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('unassembled_turn_day_1', old('unassembled_turn_day_1'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-4 {{ ($errors->has('unassembled_turn_day_2')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('unassembled_turn_day_2', old('unassembled_turn_day_2'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-4 {{ ($errors->has('unassembled_turn_day_3')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('unassembled_turn_day_3', old('unassembled_turn_day_3'), ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="form-group col-md-4 {{ ($errors->has('unassembled_turn_day_4')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('unassembled_turn_day_4', old('unassembled_turn_day_4'), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-4 {{ ($errors->has('unassembled_turn_day_5')) ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('unassembled_turn_day_5', old('unassembled_turn_day_5'), ['class' => 'form-control']) !!}
